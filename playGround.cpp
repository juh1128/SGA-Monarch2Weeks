...
HRESULT playGround::init(void)
{
	...
	IMAGEMANAGER->addFrameImage("redKing", L"resource/unit/orangeKing.png", 8, 1, false);
	IMAGEMANAGER->addFrameImage("redLv1", L"resource/unit/orangeLv1.png", 8, 1, false);
	IMAGEMANAGER->addFrameImage("redLv2", L"resource/unit/orangeLv2.png", 8, 1, false);
	IMAGEMANAGER->addFrameImage("redLv3", L"resource/unit/orangeLv3.png", 8, 1, false);
